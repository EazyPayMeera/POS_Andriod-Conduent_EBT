package com.eazypaytech.posafrica.rootUiScreens.supervisorLogin
...
@HiltViewModel
class SuperVisorLoginViewModel @Inject constructor(private var apiServiceRepository: ApiServiceRepository, private var dbRepository: TxnDBRepository) :
    ViewModel(),
