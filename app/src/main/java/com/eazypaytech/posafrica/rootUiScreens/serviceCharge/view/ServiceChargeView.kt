...
import com.eazypaytech.posafrica.rootUiScreens.serviceCharge.viewmodel.ServiceChargeViewModel
...
@Composable
fun ServiceChargeView(navHostController: NavHostController, viewModel: ServiceChargeViewModel = hiltViewModel()) {
    ...
    Column {
        ...
        GenericCard(
            ...
            Column(
                ...
                TextView(
                    text = stringResource(id = R.string.enter_service_charge),
                ...
                OutlinedTextField(
                    ...
                    placeholder = stringResource(id = R.string.service_charge),
