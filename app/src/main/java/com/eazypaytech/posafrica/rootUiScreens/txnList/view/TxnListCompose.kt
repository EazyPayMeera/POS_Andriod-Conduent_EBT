package com.eazypaytech.posafrica.rootUiScreens.txnList.view
...
import com.eazypaytech.posafrica.rootUiScreens.dialogs.DateTimePickerDialog
import com.eazypaytech.posafrica.rootUiScreens.dialogs.ListDialogueBuilder
import com.eazypaytech.posafrica.rootUiScreens.txnList.viewModel.TxnViewModel
                    ...
                    onMenuOptionClick = { selectedOption ->
                        when(selectedOption)
                        {
                            ...
                            context.resources.getString((R.string.detail)) -> {
                                viewModel.printDetailed(context,txnList)
                            }
                        }
