package com.eazypaytech.posafrica.features.voucher.ui
...
@Composable
fun VoucherCardScreen(navHostController: NavHostController, viewModel: VoucherCardViewModel = hiltViewModel()){
