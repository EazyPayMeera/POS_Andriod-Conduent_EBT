package com.eazypaytech.posafrica.features.password.ui
...
@Composable
fun PasswordScreen(navHostController: NavHostController, showPrompt: Boolean? = true, onResult: (Boolean) -> Unit = {}) {
...
object PasswordUtil {
    ...
    fun PromptUserPassword(navHostController: NavHostController, showPrompt : Boolean, onResult: (Boolean) -> Unit = {}) {
        PasswordScreen(navHostController, showPrompt) {
            onResult(it)
        }
    }
}
