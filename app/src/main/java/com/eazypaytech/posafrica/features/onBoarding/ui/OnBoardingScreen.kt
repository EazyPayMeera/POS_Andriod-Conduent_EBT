...
import com.eazypaytech.posafrica.domain.model.OnBoardingContentList
import com.eazypaytech.posafrica.core.ui.components.inputfields.AppButton
...
fun OnBoardSlideView(navHostController: NavHostController, viewModel: OnBoardingScreenViewModel = hiltViewModel()) {
    ...
    Box(
        ...
        HorizontalPager(
            ...
            OnBoardingScreen(pagerState, page, imageSlider, navHostController)
        }
