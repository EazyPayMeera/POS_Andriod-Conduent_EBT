...
interface ITxnDao {
    ...
    @Query("""SELECT * FROM TxnTable WHERE TxnType NOT IN ('BALANCE_ENQUIRY_CASH','BALANCE_ENQUIRY_SNAP','CASH_WITHDRAWAL','VOID_LAST','E_VOUCHER') AND TxnStatus = 'APPROVED'AND isVoided = 0 ORDER BY id DESC """)
