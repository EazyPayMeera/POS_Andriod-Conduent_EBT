...
interface ITxnDao {
    ...
    @Query("""SELECT * FROM TxnTable WHERE TxnType NOT IN ('BALANCE_ENQUIRY_CASH', 'BALANCE_ENQUIRY_SNAP','FOODSTAMP_RETURN','CASH_WITHDRAWAL','VOID_LAST')AND TxnStatus = 'APPROVED' ORDER BY id DESC LIMIT 1 """)
