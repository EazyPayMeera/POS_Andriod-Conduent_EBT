...
data class AidConfig(
    ...
    @SerializedName("securityCondition")    val securityCondition : String? = null,
    @SerializedName("presentationType")     val presentationType : String? = null,
    @SerializedName("terminalClass")     val terminalClass : String? = null,
