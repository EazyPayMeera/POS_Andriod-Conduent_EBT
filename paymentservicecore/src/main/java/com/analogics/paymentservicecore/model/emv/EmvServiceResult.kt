...
)
{
    ...
    class InitResult(status: InitStatus? = null, displayMsgId: DisplayMsgId? = null) : EmvServiceResult(status, displayMsgId, hostRespCode = null,additionalAmt = null, hostAuthCode = null , settlementDate = null)
    class CardCheckResult(status: CardCheckStatus? = null, displayMsgId: DisplayMsgId? = null) : EmvServiceResult(status, displayMsgId,hostRespCode = null,additionalAmt = null,hostAuthCode = null , settlementDate = null)
    class TransResult(status: TransStatus? = null, displayMsgId: DisplayMsgId? = null,hostRespCode: String? , additionalAmt: String , hostAuthCode: String , settlementDate: String) : EmvServiceResult(status, displayMsgId,hostRespCode, additionalAmt, hostAuthCode, settlementDate)
}
