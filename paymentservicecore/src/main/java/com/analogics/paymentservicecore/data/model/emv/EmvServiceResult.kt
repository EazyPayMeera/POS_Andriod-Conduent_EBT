...
)
{
    ...
    class InitResult(status: InitStatus? = null, displayMsgId: DisplayMsgId? = null) : EmvServiceResult(status, displayMsgId, paymentServiceTxnDetails = null)
    class CardCheckResult(status: CardCheckStatus? = null, displayMsgId: DisplayMsgId? = null) : EmvServiceResult(status, displayMsgId,paymentServiceTxnDetails = null)
    class TransResult(status: TransStatus? = null, displayMsgId: DisplayMsgId? = null, paymentServiceTxnDetails: PaymentServiceTxnDetails? = null) : EmvServiceResult(status, displayMsgId,paymentServiceTxnDetails)
}
